var module = angular.module("ParseAngular.Error", []);

module.factory('ParseError', function(){
...
/**
   ...
   */
  var ParseError = function(code, message) {
    this.code = code;
    this.message = message;
  };

  _.extend(ParseError, /** @lends Parse.Error */ {
    /**
...
var module = angular.module('ParseAngular.Events', []);

module.factory('ParseEvents', function(){
    var ParseEvents;
    ...
    * @class
    *
    * <p>ParseEvents is a fork of Backbone's Events module, provided for your
    * convenience.</p>
    *
    ...
    * @function
    */
    ParseEvents.bind = ParseEvents.on;

    /**
    * @function
    */
    ParseEvents.unbind = ParseEvents.off;
